package exp.count.nocov;

import umontreal.iro.lecuyer.rng.LFSR113;
import model.count.crossing.ZeroInflatedNoCovariateCrossingSparseCountTwoModeNetworkSampler;

public class ZIPTwoModeNetworkGenerator {

	public static void main(String[] args) {

		ZeroInflatedNoCovariateCrossingSparseCountTwoModeNetworkSampler sampler = new ZeroInflatedNoCovariateCrossingSparseCountTwoModeNetworkSampler();
		...
		int seed0 = Integer.parseInt(args[8].trim()) * 100;
