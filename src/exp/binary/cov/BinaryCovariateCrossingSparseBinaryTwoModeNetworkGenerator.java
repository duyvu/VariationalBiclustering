...
import model.binary.crossing.BinaryCovariateCrossingBinaryTwoModeNetworkSampler;
import umontreal.iro.lecuyer.rng.LFSR113;

public class BinaryCovariateCrossingSparseBinaryTwoModeNetworkGenerator {

	public static void main(String[] args) {

		BinaryCovariateCrossingBinaryTwoModeNetworkSampler sampler = new BinaryCovariateCrossingBinaryTwoModeNetworkSampler();
