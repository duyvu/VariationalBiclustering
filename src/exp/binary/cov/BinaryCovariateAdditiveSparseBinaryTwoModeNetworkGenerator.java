...
public class BinaryCovariateAdditiveSparseBinaryTwoModeNetworkGenerator {

	public static void main(String[] args) {

		BinaryCovariateAdditiveBinaryTwoModeNetworkSampler sampler = new BinaryCovariateAdditiveBinaryTwoModeNetworkSampler();
