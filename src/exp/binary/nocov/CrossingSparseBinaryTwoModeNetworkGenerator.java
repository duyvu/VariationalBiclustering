...
import model.binary.crossing.NoCovariateCrossingBinaryTwoModeNetworkSampler;

public class CrossingSparseBinaryTwoModeNetworkGenerator {

	public static void main(String[] args) {

		NoCovariateCrossingBinaryTwoModeNetworkSampler sampler = new NoCovariateCrossingBinaryTwoModeNetworkSampler();
