...
import model.binary.additive.NoCovariateAdditiveBinaryTwoModeNetworkSampler;

public class AdditiveSparseBinaryTwoModeNetworkGenerator {

	public static void main(String[] args) {

		NoCovariateAdditiveBinaryTwoModeNetworkSampler sampler = new NoCovariateAdditiveBinaryTwoModeNetworkSampler();
